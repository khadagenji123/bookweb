...
<body>
                ...
                <section class="row flex">
                    ...
                    <nav class="col-lg-7 col-md-0 col-sm-0 header__top-right">
                        <ul class="header__top-list">
                            ...
                            <li class="header__top-item">
                                <a href="dangky.jsp" class="header__top-link">Đăng ký</a>
                            </li>
                            <li class="header__top-item">
                                <a href="signin.jsp" class="header__top-link">Đăng nhập</a>
                            </li>
                        </ul>
                    </nav>
                </section>
                ...
                <section class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-sm-0 header__search">
                        <select name="" id="" class="header__search-select">
                            ...
                            <option value="4">Nghệ thuật sống</option>
                    ...
                    <a href="http://localhost:8080/bookweb/BuyBook?command=BUY" class="col-lg-1 col-md-1 col-sm-0 header__cart">
                    ...
                    <div class="header__nav col-lg-9 col-md-0 col-sm-0">
                        <ul class="header__nav-list">
                            <li class="header__nav-item">
                                <a href="http://localhost:8080/bookweb/" class="header__nav-link">Trang chủ</a>
                            </li>
                            <li class="header__nav-item">
                    ...
                    <ul class="menu__list">
                        <li class="menu__item menu__item--active">
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" id="Capa_1" enable-background="new 0 0 512 512"
                                    height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                                            d="m380.867 315.905h127.956c-5.445-18.383-16.927-52.259-35.617-83.367h-142.35z" />
                                        <path
                                            d="m258.13 301.651-69.438-99.195h289.504c-6.907-20.988-22.555-56.401-56.388-92.406-48.143-51.235-118.305-80.62-192.495-80.62h-7.908c-59.139 0-114.74 23.03-156.557 64.848-41.818 41.817-64.848 97.416-64.848 156.556v10.331c0 59.14 23.03 114.74 64.848 156.557 41.817 41.818 97.418 64.848 156.557 64.848h276.344l14.251-136.582h-168.715c-33.888 0-65.722-16.574-85.155-44.337zm175.584 92.419h28.283v30.204h-28.283zm-65.937 0h28.284v30.204h-28.284z" />
                                        <path
                                            d="m295.774 232.538h-49.304l36.303 51.862c13.81 19.727 36.431 31.505 60.512 31.505h2.5z" />
                                    </g>
                                </svg>
                            </a>
                        </li>
                        <li class="menu__item">
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" id="Capa_1" enable-background="new 0 0 512 512"
                                    ...
                                    <g id="XMLID_1288_">
                                        <path id="XMLID_1299_"
                                            d="m477.936 45.339c-24.408-28.814-60.065-45.339-97.827-45.339h-154.468c-37.762 0-73.419 16.525-97.827 45.339-24.409 28.813-34.848 66.702-28.64 103.95l2.025 12.147c-15.881-11.432-35.615-14.65-54.351-8.776-19.097 5.985-33.679 20.308-40.007 39.295-7.809 23.433-.914 49.162 17.565 65.549l108.898 96.572 3.944 23.666v119.258c0 8.284 6.716 15 15 15h301.252c8.284 0 15-6.716 15-15v-119.259l38.076-228.452c6.208-37.248-4.231-75.137-28.64-103.95zm-433.625 189.72c-9.478-8.404-13.014-21.601-9.009-33.618 3.245-9.738 10.725-17.084 20.519-20.154 9.796-3.067 20.127-1.307 28.35 4.836l24.149 18.039 17.144 102.864zm394.189 246.941h-271.25v-90.5h271.25zm38.484-337.643-36.191 217.143h-275.837l-36.19-217.143c-4.756-28.533 3.24-57.556 21.938-79.627 18.698-22.072 46.011-34.73 74.937-34.73h154.468c28.926 0 56.239 12.658 74.937 34.73s26.694 51.094 21.938 79.627z" />
                                        <path id="XMLID_1304_"
                                            d="m372.848 241h-120.5c-24.882 0-45.125 20.243-45.125 45.125s20.243 45.125 45.125 45.125h120.5c24.882 0 45.125-20.243 45.125-45.125s-20.243-45.125-45.125-45.125zm0 60.25h-120.5c-8.34 0-15.125-6.785-15.125-15.125s6.785-15.125 15.125-15.125h120.5c8.34 0 15.125 6.785 15.125 15.125s-6.785 15.125-15.125 15.125z" />
                                        <path id="XMLID_1305_"
                                            d="m252.348 451.75h120.5c8.284 0 15-6.716 15-15s-6.716-15-15-15h-120.5c-8.284 0-15 6.716-15 15s6.716 15 15 15z" />
                                    </g>
                                </svg>
                            </a>
                        </li>
                        <li class="menu__item">
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
                                    width="512" height="512">
                                    <g id="outline">
                                        <path
                                            d="M29.018,2a4,4,0,0,0-4,4v.556a3.962,3.962,0,0,0-2-.556,4,4,0,0,0-4,4V24.586l-2.134-2.134a4.642,4.642,0,0,0-6.38-.308A4.5,4.5,0,0,0,9,25.4a4.556,4.556,0,0,0,1.328,3.327l8.689,8.689V40a1,1,0,0,0,.293.707l3.621,3.622-.876,4.4A3.54,3.54,0,0,0,22.7,51.75a3.16,3.16,0,0,0,1.316,1.026V61a1,1,0,0,0,1,1h15a1,1,0,0,0,1-1V52.771a3.146,3.146,0,0,0,1.238-.961A3.624,3.624,0,0,0,43,48.836l-.916-5.493,2.637-2.636A1,1,0,0,0,45.018,40V14a4,4,0,0,0-4-4,3.956,3.956,0,0,0-2,.556V10a4,4,0,0,0-4-4,3.956,3.956,0,0,0-2,.556V6A4,4,0,0,0,29.018,2Zm10,58h-13V53h13Zm-4-52a2,2,0,0,1,2,2V25h2V14a2,2,0,0,1,4,0V39.586l-2.629,2.628A12.857,12.857,0,0,1,34.018,44v2a14.823,14.823,0,0,0,6.245-1.451l.784,4.694a1.7,1.7,0,0,1-.367,1.336.942.942,0,0,1-.662.421h-15a.992.992,0,0,1-.719-.454A1.611,1.611,0,0,1,24,49.2l1-5a1,1,0,0,0-.273-.9l-3.707-3.707V37a1,1,0,0,0-.293-.707l-8.982-8.982a2.537,2.537,0,0,1,.1-3.681,2.679,2.679,0,0,1,3.628.236l7.841,7.841a1,1,0,0,0,.707.293c.034,0,3.484.029,5.168,2.555l1.664-1.11a8.531,8.531,0,0,0-6.4-3.424l-3.434-3.435V10a2,2,0,0,1,4,0V25h2V6a2,2,0,0,1,4,0V25h2V10A2,2,0,0,1,35.018,8Z" />
                                    </g>
                                </svg>
                        ...
                        <li class="menu__item">
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" id="Capa_1" enable-background="new 0 0 513.529 513.529"
                                    height="512" viewBox="0 0 513.529 513.529" width="512"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="XMLID_389_">
                                        <path id="XMLID_390_"
                                            d="m349.466 219.964-86.783 37.171c-1.89.809-3.904 1.215-5.919 1.215s-4.029-.405-5.919-1.215l-86.783-37.171v267.44h185.403v-267.44z" />
                                        <path id="XMLID_391_"
                                            d="m133.997 442.307-118.455-48.441v25.077c0 37.578 23.886 66.794 59.476 78.768l38.607 14.809c9.823 3.768 20.372-3.484 20.372-14.005z" />
                                        <path id="XMLID_392_" d="m133.997 253.792v-46.706l-118.455-50.736v49.002z" />
                                        <path id="XMLID_393_" d="m133.997 409.824v-45.033l-118.455-48.44v45.032z" />
                                        <path id="XMLID_394_" d="m133.997 332.308v-46.033l-118.455-48.44v46.033z" />
                                        <path id="XMLID_397_" d="m379.532 364.791v45.033l118.456-48.441v-45.032z" />
                                        <path id="XMLID_398_" d="m379.532 207.086v46.706l118.456-48.441v-49.001z" />
                                        <path id="XMLID_399_" d="m379.532 286.275v46.033l118.456-48.44v-46.034z" />
                                        <path id="XMLID_400_"
                                            d="m379.532 442.307v56.208c0 10.521 10.549 17.773 20.372 14.005l38.607-14.809c35.59-11.975 59.476-45.19 59.476-82.768v-21.077z" />
                                        <path id="XMLID_404_"
                                            d="m256.765 226.962 230.726-98.823c-10.374-12.299-31.104-35.093-59.804-58.034-.94-.751-1.882-1.485-2.824-2.225-19.729 54.52-72.015 93.588-133.258 93.588h-69.679c-61.244 0-113.529-39.068-133.258-93.588-.942.739-1.884 1.474-2.824 2.225-28.7 22.941-49.43 45.735-59.804 58.034z" />
                                        <path id="XMLID_405_"
                                            d="m225.141 66.814h63.247c27.253 0 49.489-21.822 50.191-48.908-27.409-10.399-54.866-15.68-81.815-15.68s-54.405 5.28-81.815 15.68c.703 27.087 22.94 48.908 50.192 48.908z" />
                                        <path id="XMLID_406_"
                                            d="m304.092 130.698c55.677-6.228 99.108-53.58 99.108-110.892v-4.806c0-8.284-6.716-15-15-15h-2.931c-9.221 0-16.571 7.544-16.59 16.765-.083 38.821-27.863 71.252-64.587 78.564z" />
                                        <path id="XMLID_407_"
                                            d="m209.437 130.698v-35.37c-36.724-7.312-64.504-39.743-64.587-78.564-.019-9.22-7.369-16.764-16.59-16.764h-2.931c-8.284 0-15 6.716-15 15v4.806c0 57.312 43.431 104.664 99.108 110.892z" />
                                        <path id="XMLID_413_" d="m239.504 96.881h34.521v34.52h-34.521z" />
                                    </g>
                                </svg>
                            </a>
                        </li>
                        ...
                        <li class="menu__item">
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" version="1.1" id="Capa_1"
                            ...
                            <a href="#" class="menu__link">
                                <svg class="menu__item-icon" version="1.1" id="Capa_1"
                                    ...
                                    <g>
                                        <g>
                                            <path
                                                d="M376,304H112c-4.418,0-8,3.582-8,8v112c0,4.418,3.582,8,8,8h264c4.418,0,8-3.582,8-8V312C384,307.582,380.418,304,376,304
            ...
            <div class="row mt-4 mb-4">
                <div class="col-lg-6 col-md-6 col-sm-12 contact__self">
                    ...
                    <ul class="contact__self-list">
                        <li class="contact__self-item">
                            <a class="contact__self-link" href="#">BookstoreOnline.com</a>
                        </li>
                        <li class="contact__self-item">
                            <a class="contact__self-link" href="#">SĐT: 0377.953.849</a>
                        </li>
                        <li class="contact__self-item">
                            <a class="contact__self-link" href="#">Email: htinh7444@gmail.com</a>
                        </li>
                        <li class="contact__self-item">
                            <a class="contact__self-link" href="#">Địa chỉ:151 Tôn Đức Thắng, Liên Chiểu, Tp Đà Nẵng</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 contact__regist">
                    ...
                    <form>
                        ...
                        <input type="text" id="subject" aria-describedby="emailHelp"
                            placeholder="Chủ đề...">
                        <input type="text" id="message" class="input-mess" placeholder="Nội dung cần tư vấn...">
                        <input type="button" id="myBtn" value="Gửi liên hệ">
    ...
    <footer>
                ...
                <div class="row">
                    <article class="footer__top-intro col-lg-5 col-md-4 col-sm-6">
                        ...
                        <div class="footer__top-intro-content">
                            BookstoreOnline.com là hệ thống chuyên cung cấp sách mới nhất, trên khắp cả nước.Chúng tôi
                            sẽ liên tục cập
                            nhật những sản phẩm mới nhất, chất lượng nhất,
                            hợp thời với bạn nhất giúp các bạn học hỏi nhiều kiến thức mới trong sách!<br><br>
                            Điện thoại: 0377953849<br>
                            Email: htinh7444@gmail.com <br>
                            Zalo: 0377953849<br>
                        </div>
                    </article>
                    ...
                    <article class="footer__top-contact-wrap col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="footer__top-contact">
                            <div class="footer__top-contact-icon">
                                <img src="../image/images_contact/phone_top.png" class="footer__top-contact-img">
                            </div>
                        ...
                        <div class="footer__top-contact-social">
                            <a href="#" class="footer__top-contact-social-link">
                                <img src="../image/images_contact/facebook.png">
                            </a>
                            <a href="#" class="footer__top-contact-social-link">
                                <img src="../image/images_contact/youtube.png">
                            </a>
                            <a href="#" class="footer__top-contact-social-link">
                                <img src="../image/images_contact/tiktok.png">
                            </a>
                            <a href="#" class="footer__top-contact-social-link">
                                <img src="../image/images_contact/zalo.png">
                            </a>
                        </div>
                    </article>
                </div>
        ...
        <section class="footer__bottom">
            <div class="container">
                <div class="row">
                    <span class="footer__bottom-content">@Bản quyền thuộc về BookstoreOnline.com | Thiết kế bởi Quan
                        Tính</span>
                </div>
            </div>
        </section>
